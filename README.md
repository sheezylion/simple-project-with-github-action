...
In this project, we'll use GitHub Actions as our CI tool to check for syntax errors in a simple python function whenever changes are pushed to the repository.
